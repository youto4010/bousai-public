...
namespace UniGLTF
{
    ...
    {
        public UrpGltfPbrMaterialImporter PbrMaterialImporter { get; } = new UrpGltfPbrMaterialImporter();
        public UrpGltfDefaultMaterialImporter DefaultMaterialImporter { get; } = new UrpGltfDefaultMaterialImporter();
